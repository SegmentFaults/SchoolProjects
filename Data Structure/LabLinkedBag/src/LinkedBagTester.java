...
public class LinkedBagTester {
	...
	public void testAdd() {
		...
		assertTrue(success);
		assertTrue(bag.contains(new String(new String("A"))));
		...
		assertTrue(success);
		assertTrue(bag.contains(new String(new String("B"))));
	...
	public void testContains() {
		...
		found = bag.contains(new String(new String("A")));
		assertFalse(found);
		...
		found = bag.contains(new String(new String("B")));
		assertTrue(found);
		found = bag.contains(new String(new String("C")));
		assertTrue(found);
		found = bag.contains(new String(new String("D")));
		assertFalse(found);
	...
	public void testRemove() {
		...
		assertEquals(result, new String(new String("A")));
		...
		assertFalse(bag.contains(new String(new String("A"))));
	...
	public void testRemoveT() {
		...
		success = bag.remove(new String(new String("A")));		
		assertTrue(success);
		...
		assertTrue(success);
		assertEquals(3, bag.getCurrentSize());
		assertFalse(bag.contains(new String(new String("C"))));
