...
public class SetTester {
	public static void main(String[] args) {
		// These strings are used to populate our array.
				...
				LinkedSet<String> firstSet = new LinkedSet<String>();// default
																						// size
																						// 10
				// this second set will be used to union the array
				LinkedSet<String> secondSet = new LinkedSet<String>();
				// this will be used for intersects.
				LinkedSet<String> thirdSet = new LinkedSet<String>();
				...
				LinkedSet<String> unioned = (LinkedSet<String>) firstSet.union(secondSet);
				...
				LinkedSet<String> unioned2 = (LinkedSet<String>) unioned.union(firstSet);
				...
				LinkedSet<String> intersected = (LinkedSet<String>) unioned2.intersection(firstSet);
				...
				LinkedSet<String> intersected2 = (LinkedSet<String>) thirdSet.intersection(firstSet);
				...
				LinkedSet<Integer> intsUnion = new LinkedSet<Integer>();
				LinkedSet<Integer> intsUnion2 = new LinkedSet<Integer>();
